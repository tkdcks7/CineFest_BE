...
SECRET_KEY = 'django-insecure-8w&6q*jzbz69rfnm!yw2=nzh(e*1=w(!b2pcsiz(67nb&521&l'
...
TMDB_IMG_URL = env('TMDB_IMG_URL')
OPENWEATHER_API_KEY = env('OPENWEATHER_API_KEY')
OPENWEATHER_LOCATION_URL= env('OPENWEATHER_LOCATION_URL')
OPENWEATHER_WEATHER_URL = env('OPENWEATHER_WEATHER_URL')
